    ...
    <div className={classnames(bem, themeClass, 'error-page')}>
      ...
      >
        ...
        <g id="robot_main">
          <g id="body">
            ...
            <path
              fill="#DCE0DA"
              d="M201.3 521.1c0.2-0.6 0.4-1.1 0.7-1.6C201.8 520 201.6 520.6 201.3 521.1z"
            />
            ...
            <path
              fill="#DCE0DA"
              d="M199.2 530.3c0.1-0.5 0.1-1 0.2-1.4C199.3 529.4 199.2 529.9 199.2 530.3z"
            />
            <path
              fill="#DCE0DA"
      ...
      <CardWidget title="Oops, something went wrong!" icon={false}>
        <div>
          ...
          <br></br>
          <KsButton onClick={handleClick} color="primary">
            Return Home
          </KsButton>
          <br></br>
        </div>

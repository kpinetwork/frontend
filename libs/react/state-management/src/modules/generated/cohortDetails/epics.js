...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "cohortDetails" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "cohortDetails" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "cohortDetails" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "cohortDetails" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "cohortDetails" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "cohortDetails" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "cohortDetails" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "cohortDetails" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "cohortDetails" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "cohortDetails" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "cohortDetails" workflow.
 */

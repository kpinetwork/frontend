...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "aboutKpiNetwork" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "aboutKpiNetwork" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "aboutKpiNetwork" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "aboutKpiNetwork" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "aboutKpiNetwork" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('aboutKpiNetwork')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "aboutKpiNetwork" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "aboutKpiNetwork" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "aboutKpiNetwork" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "aboutKpiNetwork" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "aboutKpiNetwork" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "aboutKpiNetwork" workflow.
 */
